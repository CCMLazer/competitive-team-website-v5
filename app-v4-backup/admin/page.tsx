...
export default function Admin() {
  ...
  const save = async () => {
    try {
      ...
      alert(
        "Failed to save website. Check the browser console."
      );
    }
  };
        ...
        <aside>
          ...
          <button
            onClick={() => {
              if (
                confirm(
                  "Reset the website to its default settings?"
                )
              ) {
                setS(DEFAULT);
              }
